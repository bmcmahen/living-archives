...
if ( locals.villainQuote)
{
buf.push("<p>" + (jade.escape(null == (jade.interp = villainQuote) ? "" : jade.interp)) + "</p>");
...
if ( locals.ambiQuote)
{
buf.push("<p>" + (jade.escape(null == (jade.interp = ambiQuote) ? "" : jade.interp)) + "</p>");
...
buf.push("</em></div><a class=\"personInfo\">More Info</a></div>");
}
return buf.join("");
}
});
